...
-- PASO 3
-- Tu código aquí
UPDATE usuarios SET id_categoria = 1 WHERE id_usuario IN (2, 7);
UPDATE usuarios SET id_categoria = 2 WHERE id_usuario IN (1, 11);
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (5, 15);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (4, 18);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (3, 12);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (6, 17);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (8, 20);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (9, 16);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (10, 19);
UPDATE usuarios SET id_categoria = 10 WHERE id_usuario IN (13, 14);
...
FROM usuarios 
JOIN roles ON usuarios.id_rol=roles.id_rol
JOIN categorias ON usuarios.id_categoria = categorias.id_categorias
...
JOIN categorias ON usuarios_categorias.id_categoria = categorias.id_categorias;
